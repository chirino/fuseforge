...
# {http://localhost:8080/rpc/soap/jirasoapservice-v2}ArrayOf_tns1_RemoteSecurityLevel
...
# {http://localhost:8080/rpc/soap/jirasoapservice-v2}ArrayOf_tns1_RemoteWorklog
