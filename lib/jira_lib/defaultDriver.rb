...
class JiraSoapService < ::SOAP::RPC::Driver
  ...
  Methods = [
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getComment"),
      ...
      { :request_style =>  :rpc, :request_use =>  :encoded,
        ...
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "createGroup"),
      ...
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteValidationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteValidationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "login"),
      ...
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getUser"),
      ...
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getIssue"),
      ...
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getAvailableActions"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["retval", "getAvailableActionsReturn", ["ArrayOf_tns1_RemoteNamedObject", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteNamedObject"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "updateIssue"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["in", "in2", ["ArrayOf_tns1_RemoteFieldValue", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteFieldValue"]],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getComponents"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["retval", "getComponentsReturn", ["ArrayOf_tns1_RemoteComponent", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteComponent"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getSecurityLevel"),
      ...
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getPriorities"),
      ...
      "getPriorities",
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getPrioritiesReturn", ["ArrayOf_tns1_RemotePriority", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemotePriority"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getResolutions"),
      ...
      "getResolutions",
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getResolutionsReturn", ["ArrayOf_tns1_RemoteResolution", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteResolution"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getIssueTypes"),
      ...
      "getIssueTypes",
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getIssueTypesReturn", ["ArrayOf_tns1_RemoteIssueType", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteIssueType"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getStatuses"),
      ...
      "getStatuses",
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getStatusesReturn", ["ArrayOf_tns1_RemoteStatus", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteStatus"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getSubTaskIssueTypes"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getSubTaskIssueTypesReturn", ["ArrayOf_tns1_RemoteIssueType", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteIssueType"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getProjectRoles"),
      ...
      "getProjectRoles",
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getProjectRolesReturn", ["ArrayOf_tns1_RemoteProjectRole", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteProjectRole"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "addActorsToProjectRole"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["ArrayOf_xsd_string", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_xsd_string"]],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getAssociatedNotificationSchemes"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["RemoteProjectRole", "http://beans.soap.rpc.jira.atlassian.com", "RemoteProjectRole"]],
        ["retval", "getAssociatedNotificationSchemesReturn", ["ArrayOf_tns1_RemoteScheme", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteScheme"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getAssociatedPermissionSchemes"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["RemoteProjectRole", "http://beans.soap.rpc.jira.atlassian.com", "RemoteProjectRole"]],
        ["retval", "getAssociatedPermissionSchemesReturn", ["ArrayOf_tns1_RemoteScheme", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteScheme"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getCustomFields"),
      ...
      "getCustomFields",
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getCustomFieldsReturn", ["ArrayOf_tns1_RemoteField", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteField"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getComments"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["retval", "getCommentsReturn", ["ArrayOf_tns1_RemoteComment", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteComment"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getFavouriteFilters"),
      ...
      "getFavouriteFilters",
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getFavouriteFiltersReturn", ["ArrayOf_tns1_RemoteFilter", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteFilter"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getVersions"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["retval", "getVersionsReturn", ["ArrayOf_tns1_RemoteVersion", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteVersion"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getFieldsForEdit"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["retval", "getFieldsForEditReturn", ["ArrayOf_tns1_RemoteField", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteField"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getIssueTypesForProject"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["retval", "getIssueTypesForProjectReturn", ["ArrayOf_tns1_RemoteIssueType", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteIssueType"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getSubTaskIssueTypesForProject"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["retval", "getSubTaskIssueTypesForProjectReturn", ["ArrayOf_tns1_RemoteIssueType", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteIssueType"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getSecurityLevels"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["retval", "getSecurityLevelsReturn", ["ArrayOf_tns1_RemoteSecurityLevel", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteSecurityLevel"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "addAttachmentsToIssue"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["in", "in2", ["ArrayOf_xsd_string", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_xsd_string"]],
        ["in", "in3", ["ArrayOf_xsd_base64Binary", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_xsd_base64Binary"]],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getAttachmentsFromIssue"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["retval", "getAttachmentsFromIssueReturn", ["ArrayOf_tns1_RemoteAttachment", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteAttachment"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteValidationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteValidationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getFieldsForAction"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["in", "in2", ["::SOAP::SOAPString"]],
        ["retval", "getFieldsForActionReturn", ["ArrayOf_tns1_RemoteField", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteField"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "progressWorkflowAction"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["in", "in2", ["::SOAP::SOAPString"]],
        ["in", "in3", ["ArrayOf_tns1_RemoteFieldValue", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteFieldValue"]],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "addWorklogWithNewRemainingEstimate"),
      ...
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteValidationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteValidationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getWorklogs"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["retval", "getWorklogsReturn", ["ArrayOf_tns1_RemoteWorklog", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteWorklog"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteValidationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteValidationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "hasPermissionToCreateWorklog"),
      ...
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteValidationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteValidationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getNotificationSchemes"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getNotificationSchemesReturn", ["ArrayOf_tns1_RemoteScheme", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteScheme"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getPermissionSchemes"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getPermissionSchemesReturn", ["ArrayOf_tns1_RemotePermissionScheme", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemotePermissionScheme"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getAllPermissions"),
      ...
      "getAllPermissions",
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getAllPermissionsReturn", ["ArrayOf_tns1_RemotePermission", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemotePermission"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getIssuesFromTextSearch"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["retval", "getIssuesFromTextSearchReturn", ["ArrayOf_tns1_RemoteIssue", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteIssue"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getIssuesFromTextSearchWithProject"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ...
        ["in", "in2", ["::SOAP::SOAPString"]],
        ["in", "in3", ["::SOAP::SOAPInt"]],
        ["retval", "getIssuesFromTextSearchWithProjectReturn", ["ArrayOf_tns1_RemoteIssue", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteIssue"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getProjectsNoSchemes"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getProjectsNoSchemesReturn", ["ArrayOf_tns1_RemoteProject", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteProject"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getSavedFilters"),
      ...
      "getSavedFilters",
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getSavedFiltersReturn", ["ArrayOf_tns1_RemoteFilter", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteFilter"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    ...
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getSecuritySchemes"),
      ...
      "getSecuritySchemes",
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["retval", "getSecuritySchemesReturn", ["ArrayOf_tns1_RemoteScheme", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteScheme"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemoteAuthenticationException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteAuthenticationException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}, "RemotePermissionException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemotePermissionException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ],
    [ XSD::QName.new(NsSoapRpcJiraAtlassianCom, "getIssuesFromFilter"),
      ...
      [ ["in", "in0", ["::SOAP::SOAPString"]],
        ["in", "in1", ["::SOAP::SOAPString"]],
        ["retval", "getIssuesFromFilterReturn", ["ArrayOf_tns1_RemoteIssue", "http://localhost:8080/rpc/soap/jirasoapservice-v2", "ArrayOf_tns1_RemoteIssue"]] ],
      { :request_style =>  :rpc, :request_use =>  :encoded,
        :response_style => :rpc, :response_use => :encoded,
        :faults => {"RemoteException_"=>{:encodingstyle=>"http://schemas.xmlsoap.org/soap/encoding/", :use=>"encoded", :name=>"RemoteException", :ns=>"http://localhost:8080/rpc/soap/jirasoapservice-v2", :namespace=>"http://localhost:8080/rpc/soap/jirasoapservice-v2"}} }
    ]
  ...
  def initialize(endpoint_url = nil)
    ...
    self.mapping_registry = DefaultJiraMappingRegistry::EncodedRegistry
    self.literal_mapping_registry = DefaultJiraMappingRegistry::LiteralRegistry
    init_methods
  end
